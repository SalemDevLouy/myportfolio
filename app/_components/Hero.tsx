    ...
    <div className='relative top-[-80px] '>
      ...
      <div className='absolute top-0 left-0 flex flex-col gap-3 justify-center items-center w-full h-full'>
        <div className=' md:w-[650px] flex flex-col items-center justify-center'>
          <h1 className='text-gray-100 px-2  md:text-[60px] text-4xl font-bold text-center animate-typing overflow-hidden whitespace-nowrap border-r-4 border-r-white'>
          Hello I'm Salem
        </h1>
